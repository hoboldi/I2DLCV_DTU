...
class Network(nn.Module):
    def __init__(self, num_classes=10, dropout_rate=0.0, use_batchnorm=False, avgLogits = True, in_channels =3, img_size=64):
    ...
    def forward(self, x):
        # ----- Spatial stream -----
        s = self.poolS(F.relu(self.bn1S(self.conv1S(x))))
